    ...
    sentences: [
      {
        ...
        reveal: { cumulativeInformationRevealed: 20 },
        engagement: {
          controversy: 80,
          unresolvedQuestion: 70,
      ...
      },
      {
        ...
        reveal: { cumulativeInformationRevealed: 75 },
        engagement: {
          controversy: 30,
          unresolvedQuestion: 20,
          disagreementPotential: 20,
          identityInvolvement: 30,
          frictionConfusion: 15,
        },
      },
    ],
    shareability: {
