...
- The plan must be in the SAME LANGUAGE as the founder's request (a
  Vietnamese request gets a Vietnamese plan).
...
export type CraftOrAskResult = ContentPlan;

/**
 * The entry point: with a one-line request (or a full onboarding
 * payload) the AI crafts the plan.
 */
