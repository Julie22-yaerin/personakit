    ...
    <div className="site-shell">
      ...
      <header className="site-nav">
        ...
        <div className="nav-actions">
          <Link href="/login" className="nav-apply" style={{ textDecoration: "none" }}>Studio</Link>
      ...
      <footer className="site-footer section-dark">
        <div className="container footer-top"><div className="footer-brand"><a className="wordmark" href="#top" onClick={(event) => { event.preventDefault(); goTo("top"); }}><span className="wordmark-mark">◦</span><span>The Lyceum</span></a><p>Applied psychology. Practiced.</p></div><div className="footer-nav"><div><span>Explore</span><button onClick={() => goTo("method")} type="button">Method</button><button onClick={() => goTo("experience")} type="button">Experience</button><button onClick={() => goTo("packs")} type="button">Packs</button><button onClick={() => goTo("philosophy")} type="button">Philosophy</button></div><div><span>Elsewhere</span><Link href="/login">Studio</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><a href="mailto:hello@thelyceum.studio">Contact</a></div></div></div>
